...
def convert_out(settings: Settings) -> SettingsOutput:
    ...
    browser_model_section: SettingsSection = {
        ...
        "description": "Settings for the web browser model. Atulya Zero uses <a href='https://github.com/browser-use/browser-use' target='_blank'>browser-use</a> ai framework to handle web interactions.",
