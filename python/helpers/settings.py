...
class Settings(TypedDict):
    ...
    atulya_prompts_subdir: str
    atulya_memory_subdir: str
    atulya_knowledge_subdir: str
...
def convert_out(settings: Settings) -> SettingsOutput:
    ...
    chat_model_fields.append(
        {
            ...
            "description": "Select provider for main chat model used by Atulya Zero",
            "type": "select",
    ...
    chat_model_fields.append(
        {
            ...
            "description": "Portion of context window dedicated to chat history visible to the atulya. Chat history will automatically be optimized to fit. Smaller size will result in shorter and more summarized history. The remaining space will be used for system prompt, RAG and response.",
            "type": "range",
            "min": 0.01,
            "max": 1,
            "step": 0.01,
    ...
    chat_model_section: SettingsSection = {
        "id": "chat_model",
        "title": "Chat Model",
        "description": "Selection and settings for main chat model used by Atulya Zero",
    ...
    embed_model_section: SettingsSection = {
        ...
        "description": "Settings for the embedding model used by Atulya Zero.",
    ...
    browser_model_section: SettingsSection = {
        ...
        "description": "Settings for the web browser model. Atulya Zero uses <a href='https://github.com/browser-use/browser-use' target='_blank'>browser-use</a> atulyaic framework to handle web interactions.",
    ...
    auth_section: SettingsSection = {
        ...
        "description": "Settings for authentication to use Atulya Zero Web UI.",
        "fields": auth_fields,
        "tab": "external",
    }
    ...
    api_keys_section: SettingsSection = {
        "id": "api_keys",
        "title": "API Keys",
        "description": "API keys for model providers and services used by Atulya Zero.",
        "fields": api_keys_fields,
        "tab": "external",
    }

    # Atulya config section
    atulya_fields: list[SettingsField] = []

    atulya_fields.append(
        {
            "id": "atulya_prompts_subdir",
            "title": "Prompts Subdirectory",
            "description": "Subdirectory of /prompts folder to use for atulya prompts. Used to adjust atulya behaviour.",
            "type": "select",
            "value": settings["atulya_prompts_subdir"],
            "options": [
    ...
    atulya_fields.append(
        {
            "id": "atulya_memory_subdir",
            "title": "Memory Subdirectory",
            "description": "Subdirectory of /memory folder to use for atulya memory storage. Used to separate memory storage between different instances.",
            "type": "text",
            "value": settings["atulya_memory_subdir"],
            # "options": [
            #     {"value": subdir, "label": subdir}
    ...
    atulya_fields.append(
        {
            "id": "atulya_knowledge_subdir",
            "title": "Knowledge subdirectory",
            "description": "Subdirectory of /knowledge folder to use for atulya knowledge import. 'default' subfolder is always imported and contains framework knowledge.",
            "type": "select",
            "value": settings["atulya_knowledge_subdir"],
            "options": [
                {"value": subdir, "label": subdir}
    ...
    atulya_section: SettingsSection = {
        "id": "atulya",
        "title": "Atulya Config",
        "description": "Atulya parameters.",
        "fields": atulya_fields,
        "tab": "atulya",
    }
...
def get_default_settings() -> Settings:
    ...
    return Settings(
        ...
        auth_password="",
        root_password="",
        atulya_prompts_subdir="default",
        atulya_memory_subdir="default",
        atulya_knowledge_subdir="custom",
...
def _apply_settings(previous: Settings | None):
    ...
    if _settings:
        ...
        for ctx in AtulyaContext._contexts.values():
            ...
            # apply config to atulyas
            atulya = ctx.atulya0
            while atulya:
                atulya.config = ctx.config
                atulya = atulya.get_data(atulya.DATA_NAME_SUBORDINATE)
