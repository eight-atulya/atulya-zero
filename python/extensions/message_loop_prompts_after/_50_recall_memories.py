...
class RecallMemories(Extension):
    ...
    async def search_memories(self, loop_data: LoopData, **kwargs):
        ...
        #     self.atulya.history[-RecallMemories.HISTORY :]
        # )  # only last X messages
        msgs_text = self.atulya.history.output_text()[-RecallMemories.HISTORY:]
        ...
        # place to prompt
        memories_prompt = self.atulya.parse_prompt(
            "atulya.system.memories.md", memories=memories_text
        )
