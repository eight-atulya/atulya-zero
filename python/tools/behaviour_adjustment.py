...
class UpdateBehaviour(Tool):
    ...
    async def execute(self, adjustments:str="", **kwargs):
        ...
        return Response(message=self.atulya.read_prompt("behaviour.updated.md"), break_loop=False)
...
async def update_behaviour(atulya: Atulya, log_item: LogItem, adjustments: str):
    ...
    msg = atulya.read_prompt("behaviour.merge.msg.md", current_rules=current_rules, adjustments=adjustments)
