...
class Message(ApiHandler):
    ...
    async def respond(self, task: DeferredTask, context: AtulyaContext):
    ...
    async def communicate(self, input: dict, request: Request):
        ...
        # Obtain atulya context
        context = self.get_context(ctxid)

        # Store attachments in atulya data
        # context.atulya0.set_data("attachments", attachment_paths)
