import asyncio
import models
from atulya import AtulyaConfig, ModelConfig
...
def initialize():
    ...
    config = AtulyaConfig(
        ...
        prompts_subdir=current_settings["atulya_prompts_subdir"],
        memory_subdir=current_settings["atulya_memory_subdir"],
...
def set_runtime_config(config: AtulyaConfig, set: settings.Settings):
