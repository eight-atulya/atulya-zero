            ...
            try {
                ...
                if (data.success && data.tunnel_url) {
                    ...
                    if (this.tunnelLink !== data.tunnel_url) {
                        ...
                        localStorage.setItem('atulya_zero_tunnel_url', data.tunnel_url);
                    }
                    this.linkGenerated = true;
                } else {
                    // Check if we have a stored tunnel URL
                    const storedTunnelUrl = localStorage.getItem('atulya_zero_tunnel_url');
                    ...
                    if (storedTunnelUrl) {
                        ...
                        if (verifyData.success && verifyData.is_valid) {
                            ...
                            // Clear stale URL
                            localStorage.removeItem('atulya_zero_tunnel_url');
                            this.tunnelLink = '';
            ...
            try {
                ...
                if (!hasAuth) {
                    const proceed = confirm(
                        "WARNING: No authentication is configured for your Atulya Zero instance.\n\n" +
                        "Creating a public tunnel without authentication means anyone with the URL " +
                        "can access your Atulya Zero instance.\n\n" +
                ...
                if (data.success && data.tunnel_url) {
                    ...
                    try {
                        ...
                        if (statusData.success && statusData.tunnel_url) {
                            ...
                            localStorage.setItem('atulya_zero_tunnel_url', statusData.tunnel_url);
