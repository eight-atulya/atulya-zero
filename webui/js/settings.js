const settingsModalProxy = {
    ...
    async openModal() {
        ...
        try {
            ...
            setTimeout(() => {
                // Get stored tab or default to 'atulya'
                const savedTab = localStorage.getItem('settingsActiveTab') || 'atulya';
...
document.addEventListener('alpine:init', function () {
    ...
    Alpine.store('root', {
        activeTab: localStorage.getItem('settingsActiveTab') || 'atulya',
        isOpen: false,
    ...
    Alpine.data('settingsModal', function () {
        return {
            ...
            async init() {
                ...
                this.activeTab = Alpine.store('root').activeTab || 'atulya';
