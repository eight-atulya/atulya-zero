...
export function drawMessageAtulya(
  messageContainer,
  id,
  type,
  heading,
...
export function drawMessageResponse(
  ...
  _drawMessage(
    ...
    true,
    null,
    ["message-ai", "message-atulya-response"],
    [],
    true
  );
}
...
export function drawMessageDelegation(
  ...
  _drawMessage(
    ...
    true,
    kvps,
    ["message-ai", "message-atulya", "message-atulya-delegation"],
    [],
    true
  );
}
...
export function drawMessageAtulyaPlain(
  classes,
  messageContainer,
  id,
  type,
